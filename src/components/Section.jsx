...
export default function Section() {
  ...
  return (
    <div className='Projects pt-[30px] sm:pt-[40px] md:pt-[70px] bg-[#0a101e]'>
        <div className="container m-auto">
            ...
            <div className='grid grid-cols-1 px-[15px] sm:px-0 w-full sm:w-[80%] md:w-full xls:w-full lg:grid-cols-2 gap-[30px] lg:w-[90%] xl:gap-[50px] xl:w-[1000px] m-auto mt-[50px]'>
                ...
                <div className='bg-[#161031] p-[15px] sm:p-[20px] rounded-2xl grid md:grid-cols-2 lg:grid-cols-1 gap-3 sm:gap-5 items-center' data-aos = 'fade-up'>
                    ...
                    <div className='md:w-[330px] lg:w-auto h-[140px] w-full x310:h-[150px] x350:h-[170px] xs:h-[190px] sm:h-[270px] xls:h-[260px] md:h-[230px] lg:h-[250px] overflow-y-hidden rounded-2xl' onMouseEnter={() => setHoveredOne(true)} onMouseLeave={() => setHoveredOne(false)}>
                        <div className='hover:cursor-pointer'>
                            <img src={portfolio} className={`${hoveredOne ? 'transition-transform duration-[5s] ease-[ease-in-out] delay-[0s] translate-y-[-80%]' : 'transition-transform duration-[5s] ease-[ease-in-out] delay-[0s] translate-y-[0%]'} w-full rounded-2xl`} alt="" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className='mt-[20px] md:mt-[10px] lg:mt-[30px] flex items-center justify-between xls:justify-evenly'>
                            <a href='/' className='button-85 flex items-center justify-center gap-2' role="button">
                            ...
                            <a target='_blank' href='https://github.com/jasurkhaitov/Portfolio' className='button-85 flex items-center justify-center gap-2' role="button">
                ...
                <div className='bg-[#161031] p-[15px] sm:p-[20px] rounded-2xl grid md:grid-cols-2 lg:grid-cols-1 gap-3 sm:gap-5 items-center' data-aos = 'fade-up'>
                    ...
                    <div>
                        ...
                        <div className='mt-[20px] md:mt-[10px] lg:mt-[30px] flex items-center justify-between xls:justify-evenly'>
                            <a target='_blank' href='https://travlog-eosin.vercel.app/' className='button-85 flex items-center justify-center gap-2' role="button">
                                <span className='text-[17px] font-bold text-white'>Live Demo</span>
                                <Icon icon="fa6-solid:arrow-up-right-from-square" color="white" width="15" />
                            </a>

                            <a target='_blank' href='https://github.com/jasurkhaitov/Travlog' className='button-85 flex items-center justify-center gap-2' role="button">
                                <span className='text-[17px] font-bold text-white'>Code</span>
                                <Icon icon="foundation:social-github" color="white" width="20" />
                            </a>
                        </div>
